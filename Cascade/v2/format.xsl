...
<!-- CONTENT -->
        ...
        <table border="0" align="center" cellpadding="0" cellspacing="0" width="600" class="main-content">
          <tbody>

            <tr>
              <td>

                <table cellpadding="0" cellspacing="0" border="0" align="left" width="560" height="95">
                  <tbody>
                    <tr>
                      <!-- Name, date and issue information -->
                      <td width="352" class="email-info">
                        <h1>
                      ...
                      <!-- UC Santa Cruz logo -->
                      <td style="padding-right:10px;" width="208">
...
<xsl:template match="feature-section">
      ...
      <tr>
        <td class="feature-item" bgcolor="#f2f6f9">
          <h2 class="feature-headline"><a href="{$feature-link}{$tracking-vars}"><xsl:value-of select="$feature-title"/></a></h2>
...
<xsl:template match="editors-note">
  ...
  <xsl:if test="node() != ''">
    ...
    <tr>
      <td class="row editors-note">

        <table cellpadding="0" cellspacing="0" border="0" summary="Editor's note">
          <tr>
            <td>
                <h2>Editor's note</h2>
            </td>
